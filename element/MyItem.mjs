...
export const button_submit =
  ".mr-1.white--text.v-btn.v-btn--depressed.theme--light.v-size--small.blue";
export const button_complete =
  ".v-btn.v-btn--contained.theme--light.v-size--small"; //ep0
export const button_complete_success =
  ".v-list-item.v-list-item--link.theme--light";
export const btn_apply =
  ".v-btn.v-btn--flat.v-btn--text.theme--light.v-size--default.green--text.text--darken-1";
export const input_primary = "#s-control-id-1656297988119";
export const btn_approval =
  ".mr-1.white--text.v-btn.v-btn--depressed.theme--light.v-size--small.green";
export const btn_disapproval =
